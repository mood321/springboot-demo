package com.mood.springbootredis;

import com.mood.springbootredis.model.Users;
...
public class SpringbootRedisApplicationTests {
    ...
    public void stringTest() {
        ...
        String value = this.stringRedisTemplate.opsForValue().get("string");
    ...
    public void listTest() {
        this.redisTemplate.opsForList().rightPush("list-user",new Users(1,"张三"));
        this.redisTemplate.opsForList().rightPush("list-user",new Users(2,"李四"));
        List<Object> listUser = this.redisTemplate.opsForList().range("list-user",0,-1);
        log.info("============================list-user:{}===============================",listUser.toString());
        redisTemplate.delete("list-user");
        log.info( this.redisTemplate.opsForList().size("list-user").toString());
        List<Users> list = Arrays.asList(new Users(3,"王五"),new Users(4,"赵六"));
        ...
        redisTemplate.delete("list-user-list");
    ...
    @Test
    public void setTest() {
        List<Users> list1 = Arrays.asList(new Users(5,"田七"),new Users(6,"陈八"));
        this.redisTemplate.opsForSet().add("set-user1",list1.toArray());
        Set<Users> result = this.redisTemplate.opsForSet().members("set-user1");
        log.info("============================set-user1:{}===============================",result.toString());
        List<Users> list2 = Arrays.asList(new Users(6,"陈八"),new Users(7,"钱九"));
    ...
    public void zsetTest() {
        ...
        sortedArticleIds = this.redisTemplate.opsForZSet().rangeByScore("zset-articleStar",50,100);
        log.info("=========================50-100个赞以下的文章是:{}=========================",sortedArticleIds.toString());
    ...
    public void hashTest() {
        this.redisTemplate.opsForHash().put("hash-user","移动",new Users(10086,"移动"));
        this.redisTemplate.opsForHash().put("hash-user","电信",new Users(10000,"电信"));
        Users user = (Users) this.redisTemplate.opsForHash().get("hash-user","移动");

package com.mood.demo;

import com.mood.util.SolrUtil;
...
public class EasyDemo {
    ...
    public static SolrDocumentList query(String mQueryStr) {
        try {
            HttpSolrClient httpSolrClient = SolrUtil.connect();
    ...
    public static void addDoc(Map<String, Object> map) {
        try {
            ...
            document = SolrUtil.addFileds(map, document);
    ...
    public static void main(String[] args) throws  Exception {
        ...
        addDoc(map);
        SolrDocumentList query = query(10 + "");
